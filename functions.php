...
function enqueue_extra_styles() {
    // Enqueue extra.css
    wp_enqueue_style(
        'extra-css', // Handle for extra.css
        get_template_directory_uri() . '/css/extra.css', // Path to extra.css
        array(), // Dependencies
        '1.1.0', // Version
        'all' // Media type
    );
    ...
    // Enqueue output.css
    wp_enqueue_style(
        'output-css', // Handle for output.css
        get_template_directory_uri() . '/dist/output.css', // Path to output.css
        array(), // Dependencies
        '1.0.0', // Version
        'all' // Media type
    );
...
function blankslate_enqueue() {
    ...
    // Enqueue bundle.js
    wp_enqueue_script(
        'bundle-js', // Handle for bundle.js
        get_template_directory_uri() . '/dist/js/bundle.js', // Path to bundle.js
        array(), // Dependencies
        '1.0.0', // Version
        true // Load in footer
    );
